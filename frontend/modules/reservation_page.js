  ...
  */
    ...
    reservations.map((ele)=>{
     ...
     tableElement.innerHTML=`
      ...
      <td><button type="button" class="reservation-visit-button" id=${ele.id}><a href="../detail/?adventure=${ele.adventure}">Visit Adventure </a></button>
     </td>
     `
    document.getElementById("reservation-table").append(tableElement)
    })
